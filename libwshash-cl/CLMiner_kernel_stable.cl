...
__kernel void wshash_calculate_dag_item(uint start, __global hash64_t const* g_light, __global hash64_t * g_dag, uint isolate)
{
	...
	for (uint i = 0; i != WSHASH_DATASET_PARENTS; ++i) {
