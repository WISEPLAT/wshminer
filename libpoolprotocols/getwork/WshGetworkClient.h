#ifndef WSH_GETWORK_CLIENT_H_
#define WSH_GETWORK_CLIENT_H_
...
class WshGetworkClient : public PoolClient, Worker
{
public:
	WshGetworkClient(unsigned const & farmRecheckPeriod);
	~WshGetworkClient();
